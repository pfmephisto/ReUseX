...
file(GLOB REUSEX_VIS_SOURCES CONFIGURE_DEPENDS
     "${CMAKE_CURRENT_SOURCE_DIR}/src/ReUseX/visualize/*.cpp")
...
list(APPEND REUSEX_VIS_SOURCES
     "${CMAKE_CURRENT_SOURCE_DIR}/src/ReUseX/geometry/mesh.cpp"
     "${CMAKE_CURRENT_SOURCE_DIR}/src/ReUseX/geometry/texture_mesh.cpp")
...
# -----------------------------------------------
add_library(${PROJECT_NAME}_visualization SHARED ${REUSEX_VIS_SOURCES} ${REUSEX_VIS_HEADERS})
...
# Compiler options
# -----------------------------------------------
target_link_libraries(${PROJECT_NAME}_visualization PUBLIC ${COMMON_LINKER_FLAGS})
target_compile_options(${PROJECT_NAME}_visualization PUBLIC ${COMMON_COMPILER_FLAGS})

# -----------------------------------------------
# Export library information
# -----------------------------------------------
if(NOT CMAKE_CURRENT_SOURCE_DIR STREQUAL CMAKE_SOURCE_DIR)
    set(REUSEX_VISUALIZATION_LIBRARY_TARGET ${PROJECT_NAME}_visualization PARENT_SCOPE)
endif()
