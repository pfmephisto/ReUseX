...
/// absent but intensity is present, intensity is mapped to grayscale RGB.
/// Normals are stored as a separate cloud with a "_normals" suffix.
///
...
///
/// Each entry in @p scans becomes one Data3D block. RGB color is always
/// written. Normals are written using the E57_EXT_surface_normals extension
/// when provided.
///
