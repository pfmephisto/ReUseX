...
TEST_CASE("Box_GivenCoordinates_ComputesWidthHeightAreaCenter",
          "[vision][box]") {
...
TEST_CASE("Box_DefaultConstructed_AllFieldsZero", "[vision][box]") {
  Box box;
...
TEST_CASE("PosePoint_ConstructAndAssign_CopiesFields", "[vision][pose]") {
...
TEST_CASE("Obb_GivenSizeAndAngle_ComputesArea", "[vision][obb]") {
...
TEST_CASE("Depth_EmptyMatrix_StatisticsAreZero", "[vision][depth]") {
  Depth depth;
...
TEST_CASE("Depth_ValidData_ComputesAverageMinMaxAndPointDepth",
          "[vision][depth]") {
  Depth depth;
...
TEST_CASE("CreateBox_GivenParameters_BuildsDetectionObject",
          "[vision][factory]") {
...
TEST_CASE("CreateObbBox_GivenParameters_BuildsObbObjectWithAabb",
          "[vision][factory]") {
